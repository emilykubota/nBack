...
y0 = [round(mean(T.Acc00*100),3) round(mean(T.Acc10*100),3) round(mean(T.Acc20*100),3)]; 
err = [(std(T.Acc00*100)/sqrt(24)) (std(T.Acc10*100)/sqrt(24)) (std(T.Acc20*100)/sqrt(24))];
p1 = errorbar(x, y0, err, 's', 'MarkerSize',12, 'MarkerEdgeColor',[0,.5,.8], 'MarkerFaceColor',[0,.5,.8]);
set(p1,'Color',[0,.5,.8],'LineWidth', 2);

y1 = [round(mean(T.Acc01*100),3) round(mean(T.Acc11*100),3) round(mean(T.Acc21*100),3)]; 
err = [(std(T.Acc01*100)/sqrt(24)) (std(T.Acc11*100)/sqrt(24)) (std(T.Acc21*100)/sqrt(24))];
